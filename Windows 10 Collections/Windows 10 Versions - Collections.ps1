...
$DummyObject |
    Select-Object @{L = "Name"
        ; E           = {"All Windows 10"}
    }, @{L  = "Query"; E = {"select SMS_R_SYSTEM.ResourceID,SMS_R_SYSTEM.ResourceType,SMS_R_SYSTEM.Name,SMS_R_SYSTEM.SMSUniqueIdentifier,SMS_R_SYSTEM.ResourceDomainORWorkgroup,SMS_R_SYSTEM.Client from SMS_R_System where SMS_R_System.Build like '10%' and SMS_R_System.OperatingSystemNameandVersion like '%Workstation%'"}
...
$DummyObject |
    Select-Object @{L = "Name"
        ...
        ; E = {"select SMS_R_SYSTEM.ResourceID,SMS_R_SYSTEM.ResourceType,SMS_R_SYSTEM.Name,SMS_R_SYSTEM.SMSUniqueIdentifier,SMS_R_SYSTEM.ResourceDomainORWorkgroup,SMS_R_SYSTEM.Client from SMS_R_System where SMS_R_System.Build = '10.0.19041'"}
    }, @{L  = "LimitingCollection"
        ; E = {"All Windows 10"}
    }, @{L  = "Comment"
        ; E = {"Windows 10 v2004"}
...
$DummyObject |
    Select-Object @{L = "Name"
        ...
        ; E = {"select SMS_R_SYSTEM.ResourceID,SMS_R_SYSTEM.ResourceType,SMS_R_SYSTEM.Name,SMS_R_SYSTEM.SMSUniqueIdentifier,SMS_R_SYSTEM.ResourceDomainORWorkgroup,SMS_R_SYSTEM.Client from SMS_R_System where SMS_R_System.Build = '10.0.19042'"}
    }, @{L  = "LimitingCollection"
        ; E = {"All Windows 10"}
    }, @{L  = "Comment"
        ; E = {"Windows 10 v20H2"}
...
$DummyObject |
    Select-Object @{L = "Name"
        ...
        ; E = {"select SMS_R_SYSTEM.ResourceID,SMS_R_SYSTEM.ResourceType,SMS_R_SYSTEM.Name,SMS_R_SYSTEM.SMSUniqueIdentifier,SMS_R_SYSTEM.ResourceDomainORWorkgroup,SMS_R_SYSTEM.Client from SMS_R_System where SMS_R_System.Build = '10.0.19043'"}
    }, @{L  = "LimitingCollection"
        ; E = {"All Windows 10"}
    }, @{L  = "Comment"
        ; E = {"Windows 10 v21H1"}
...
$DummyObject |
    Select-Object @{L = "Name"
        ...
        ; E = {"select SMS_R_SYSTEM.ResourceID,SMS_R_SYSTEM.ResourceType,SMS_R_SYSTEM.Name,SMS_R_SYSTEM.SMSUniqueIdentifier,SMS_R_SYSTEM.ResourceDomainORWorkgroup,SMS_R_SYSTEM.Client from SMS_R_System where SMS_R_System.Build = '10.0.21390'"}
    }, @{L  = "LimitingCollection"
        ; E = {"All Windows 10"}
    }, @{L  = "Comment"
        ; E = {"Windows 10 v21H2"}
...
$DummyObject |
    Select-Object @{L = "Name"
        ; E           = {"Windows 10 Not on Latest build (21H1)"}
    }, @{L  = "Query"
        ; E = {"select SMS_R_SYSTEM.ResourceID,SMS_R_SYSTEM.ResourceType,SMS_R_SYSTEM.Name,SMS_R_SYSTEM.SMSUniqueIdentifier,SMS_R_SYSTEM.ResourceDomainORWorkgroup,SMS_R_SYSTEM.Client from SMS_R_System where SMS_R_System.Build != '10.0.19042'"}
    }, @{L  = "LimitingCollection"
        ; E = {"All Windows 10"}
